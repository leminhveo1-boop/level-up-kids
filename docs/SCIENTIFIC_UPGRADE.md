...
**Tầng 1 — Điểm treo (Escrow) + Duyệt gộp 1 phút + Trẻ được quyền "đòi duyệt":**
...
- **Cơ chế nhắc 2 chiều (trẻ chủ động):**
  - Trẻ có nút **"Nhắc bố mẹ duyệt 🕊️"** ngay trên khối điểm treo — gửi push notification sang máy bố mẹ (V1.2) / hiện badge đỏ trên icon 🔑 Phòng Bố Mẹ + banner khi bố mẹ mở app (làm được ngay). Giới hạn 2 lần nhắc/ngày để không thành spam
  - **Auto-nhắc theo giờ:** nếu 20h00 vẫn còn điểm treo → app tự gửi 1 notification cho bố mẹ ("Minh Anh có 5 nhiệm vụ chờ duyệt — 30 giây thôi ạ! ⏳"). Việc trẻ *được quyền đòi* người lớn thực hiện phần việc của mình còn dạy thêm bài học về trách nhiệm hai chiều
...
**Tầng 2 — Xác nhận THEO BẢN CHẤT NHIỆM VỤ, không random mù quáng:**

> ⚠️ *Thiết kế "random 20% đòi bằng chứng sau khi làm" bị loại bỏ qua phản biện: nhiều hành vi không thể có bằng chứng hồi tố (dậy đúng giờ, mỉm cười, tuân thủ giờ TV — khoảnh khắc trôi qua là hết). Đòi bằng chứng cho thứ không thể chứng minh chỉ tạo ức chế.*

Mỗi nhiệm vụ khi tạo được gán **1 trong 4 kiểu xác nhận** (bố mẹ chọn, wizard gợi ý mặc định):

| Kiểu | Áp dụng cho | Cách xác nhận | Ví dụ |
|---|---|---|---|
| 🤝 **Tự giác** (trust-only) | Hành vi không để lại dấu vết | Tick là tính, đi qua escrow, Uy Tín làm lưới đỡ — bố mẹ vẫn bác được lúc duyệt nếu biết sai | Mỉm cười, lễ phép, tuân thủ giờ TV |
| ⏱️ **Hẹn giờ tập trung** (process) | Việc đo được bằng thời gian | Chỉ tick được khi **stopwatch trong app chạy đủ ≥80% thời lượng** (app có sẵn stopwatch) — điều kiện biết trước, không phải đòi hồi tố | Đọc sách 20', học tiếng Anh, tập thể dục |
| 📸 **Chụp kết quả** (artifact) | Việc để lại dấu vết vật lý còn đó | Chụp ảnh kết quả ngay lúc tick (giường đã gấp vẫn đang gấp) — bằng chứng không bao giờ "trôi qua" vì là ảnh *kết quả*, không phải ảnh *quá trình* | Gấp chăn, dọn phòng, bài tập viết, tranh vẽ |
| 👀 **Bố mẹ chứng kiến** (witness) | Việc bố mẹ vốn có mặt lúc đó | Chính bố mẹ tick (hoặc xác nhận tại chỗ bằng PIN nhanh) — dành cho số ít việc quan trọng | Dậy đúng giờ (bố mẹ gọi dậy mà), đi ngủ đúng giờ |

- Yếu tố "xác suất" chỉ còn dùng **bên trong nhóm 📸**: không bắt chụp ảnh mọi ngày (friction cao) — app hiện cờ 🔍 **ngay đầu ngày** cho ~1/3 số việc artifact ("hôm nay việc này cần ảnh nhé!"), trẻ biết trước khi làm, không bao giờ bị đòi ngược
- Cơ sở lý thuyết giữ nguyên (deterrence economics: kỳ vọng gian lận phải âm) nhưng áp **đúng chỗ có thể kiểm chứng**; chỗ không thể kiểm chứng thì dùng Uy Tín (Tầng 3) — trung thực rẻ hơn gian lận về dài hạn
...
|---|---|---|---|
| **P0** | Escrow + duyệt gộp + auto-approve 24h + nút "Nhắc bố mẹ 🕊️" & auto-nhắc 20h | PDCA-Check | 2-3 ngày |
| **P0** | 4 kiểu xác nhận theo bản chất nhiệm vụ (trust/timer/photo/witness) + Chỉ số Uy Tín 🤝 | Deterrence, PDCA | 2-3 ngày |
